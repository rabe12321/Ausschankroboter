...
def handle_inputs():
    ...
    while True:
        ...
        print('licht' + diLichtschranke)
        print('ausschank aktiv' + GPIO.input(diAusschankAktiv) == GPIO.LOW and bestellung_aufgegeben)
        print('ausschank inaktiv' + GPIO.input(diAusschankAktiv) == GPIO.HIGH and flag_ausschank)
        time.sleep(0.3)
